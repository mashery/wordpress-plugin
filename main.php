...
class Mashery {
    ...
    public function keys(){
        return self::shortcode(__FUNCTION__, Mashery\API\Client::keys() );
    }

    public function profile(){
        return self::shortcode(__FUNCTION__, Mashery\API\Client::profile() );
    }

    public function iodocs(){
        return self::shortcode(__FUNCTION__, Mashery\API\Client::iodocs() );
    }

    public function documentation(){
        return self::shortcode(__FUNCTION__, Mashery\API\Client::documentation() );
    }
