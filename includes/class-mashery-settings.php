...
class Mashery_Settings {
	...
	public function add_menu_item () {
		$page = add_options_page( __( 'Plugin Settings', 'mashery' ) , __( 'Plugin Settings', 'mashery' ) , 'manage_options' , $this->parent->_token . '_settings' ,  array( $this, 'settings_page' ) );
	...
	private function settings_fields () {
		...
		$settings['standard'] = array(
			'title'					=> __( 'Standard', 'mashery' ),
			'description'			=> __( 'These are fairly standard form input fields.', 'mashery' ),
			'fields'				=> array(
				array(
					'id' 			=> 'text_field',
					'label'			=> __( 'Some Text' , 'mashery' ),
					'description'	=> __( 'This is a standard text field.', 'mashery' ),
					'type'			=> 'text',
					'default'		=> '',
		...
		$settings['extra'] = array(
			'title'					=> __( 'Extra', 'mashery' ),
			'description'			=> __( 'These are some extra input fields that maybe aren\'t as common as the others.', 'mashery' ),
			'fields'				=> array(
				array(
					'id' 			=> 'number_field',
	...
	public function settings_page () {
		...
		$html = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'Plugin Settings' , 'mashery' ) . '</h2>' . "\n";
