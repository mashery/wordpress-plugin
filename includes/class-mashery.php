...
class Mashery {
    ...
    public function __construct ( $file = '', $version = '1.0.0' ) {
        ...
        $this->mashery = new API(
            get_option($this->_token . '_apihost'),
            get_option($this->_token . '_areaid'),
            get_option($this->_token . '_areauuid'),
            get_option($this->_token . '_apikey'),
            get_option($this->_token . '_apisecret'),
            get_option($this->_token . '_username'),
            get_option($this->_token . '_password'),
            get_option($this->_token . '_test_user')
